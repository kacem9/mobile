...
public class ServiceUser {
    ...
    public boolean adduser(FosUser u) {
        String url = "http://127.0.0.1/Velo/web/app_dev.php/api/users/new?&Username=" + u.getUsername() + "&Email=" + u.getEmail() + "&Password=" + u.getPassword() + "&roles=" + u.getRoles() + "&Cin=" + u.getCin() + "&Nom=" + u.getNom() + "&Prenom=" + u.getPrenom() + "&Sexe=" + u.getSexe() + "&Date_naissance=" + u.getDate_naissance() + "&Num_tel=" + u.getNum_tel()
    ...
    public ArrayList<FosUser> getAllTasks() throws ParseException {
        String url = Statics.BASE_URL1 + "/users/alluser";
