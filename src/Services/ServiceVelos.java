...
//http://127.0.0.1/Velo/web/app_dev.php/api/newVelo?price_location=100&quantity=2&description=hhhh&localitsation_velo=h&"dateCirculation"=%222019-02-20
    ...
    public boolean updatev(int id,Velo v) {
        String url = Statics.BASE_URL +"/updatev/"+id+"?description=" +v.getDescription()+"&localitsation_velo="+v.getLocalitsation_velo()+"&photo="+v.getPhoto()+"&price_location="+v.getPrice_location()+"&quantity="+v.getQuantity()+"dateCirculation="+v.getDate_circulation();
    ...
    public ArrayList<Velo> getAllVelos() throws ParseException {
        String url = Statics.BASE_URL +"/ListVelo";
