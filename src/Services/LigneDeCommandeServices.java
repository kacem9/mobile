...
import EspaceClient.AffichageCommande;
import EspaceClient.AjoutCommandeForm;
...
public class LigneDeCommandeServices {
    ...
    public ArrayList<LigneDeCommandeProduit> getLignesCommandeProduit(Integer id) {
       ...
       //String Url = "http://127.0.0.1/Velo/web/app_dev.php/api/afflcJson/"+id;
        String Url = Statics.BASE_URL2+"/afflcJson/"+id;
     ...
     public void addCommandeAndLigneDeCommande(Integer idu) {
        try {
            ...
            connReq.setContentType("application/json");
               String url = Statics.BASE_URL2+"/AjoutCommandeJson/"+idu;
connReq.setUrl(url);  
...
connReq.setUrl("http://127.0.0.1/symfony/Velo/web/app_dev.php/api/ajoutLigneCommandeJson/"+ idu +"/"+ p.getId()+ 
   ...
   public void updateLigneDeCommande()
    {
        try {
            ...
            System.out.println("http://127.0.0.1/symfony/Velo/web/app_dev.php/api/modifierlcJson/" + AffichageCommande.idC + 
                    "?adresse=" + ip.getAdresse()+
                     "&adresse2=" + ip.getAdresse2()+ 
                    "&ville=" + ip.getVille()+ 
                    "&codepostal=" + ip.getCodePostal()+
            ...
            connReq.setPost(true);
            connReq.setContentType("application/json");
            connReq.setUrl("http://127.0.0.1/symfony/Velo/web/app_dev.php/api/modifierlcJson/" + AffichageCommande.idC + 
                    "?adresse=" + ip.getAdresse()+
                     "&adresse2=" + ip.getAdresse2()+ 
                    "&ville=" + ip.getVille()+ 
                    "&codepostal=" + ip.getCodePostal()+
