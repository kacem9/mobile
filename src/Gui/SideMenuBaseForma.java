 ...
 * @author root
 */
public abstract class SideMenuBaseForma extends Form {

    public SideMenuBaseForma(String title, Layout contentPaneLayout) {
        super(title, contentPaneLayout);
    }

    public SideMenuBaseForma(String title) {
        super(title);
    }

    public SideMenuBaseForma() {
    }

    public SideMenuBaseForma(Layout contentPaneLayout) {
