 ...
 * @author bhk
 */
public class ListVelosWishClient extends Form{
    private Resources theme;
  //  int nombreAleatoire = 20 + (int)(Math.random() * ((5 - 2) + 1));
      ArrayList<Wish> wishs=ServiceWish.getInstance().getAllwish();
       
       

    public ListVelosWishClient(Form previous) {
...
String url="http://localhost/VeloSymfonyIntegre/Velo/web/uploads/admin/"+w.getPhoto();
                    ...
                    Label nameLabel = new Label(w.getPhoto());
