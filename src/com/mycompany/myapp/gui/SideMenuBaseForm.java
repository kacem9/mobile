...
public abstract class SideMenuBaseForm extends Form {
    ...
    public void setupSideMenu(Resources res) {
        ...
        getToolbar().addMaterialCommandToSideMenu("  Velos", FontImage.MATERIAL_DIRECTIONS_BIKE,  e -> showHomeFormClient(res));
    ...
    protected abstract void showHomeFormClient(Resources res);
