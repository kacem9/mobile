...
public class Commande {
    ...
    public Commande(int id, Date dateLivraison, float prixTotal, String adresse2, String adresse, String ville, String codePostal, int numTel, int quantite) {
        this.id = id;
    ...
    public Commande(float prixTotal, String adresse2, String adresse, String ville, String codePostal, int numTel, int quantite) {
        this.prixTotal = prixTotal;
        this.adresse2 = adresse2;
        this.adresse = adresse;
        this.ville = ville;
