...
FontImage.setMaterialIcon(b, FontImage.MATERIAL_ADD_COMMENT);
    ...
    Form f1 = new Form("Edit an appointement",new FlowLayout());
              ...
              Label lOption = new Label("Edit an appointement : ");
               TextField typepannet=new TextField("","Message");
             ...
             getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previous.showBack());
               ...
               ws.modWork(p,y,SessionUser.getUser().getNom(),SessionUser.getUser().getPrenom(),SessionUser.getUser().getEmail(),SessionUser.getUser().getAdresse(),SessionUser.getUser().getNum_tel(),SessionUser.getUser().getId());
...
add(c1);
 ...
 Label lOption = new Label("you haven't any appointment ! ");
